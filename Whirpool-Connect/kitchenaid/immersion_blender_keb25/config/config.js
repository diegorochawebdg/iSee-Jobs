...
/** Nome do produto **/
var $NOME_PRODUTO   = "Immersion Blender KEB25 | KitchenAid";
var $NOME_FOLDER	= "immersion_blender_keb25/";
...
*/
var $CARACTERISTICAS = [ { nome: "Immersion Blender KEB25 | KitchenAid" ,
						   src: "caracteristicas1.html" ,
						   thumb: "<img src='caracteristicas/thumb_page1.jpg' width='128' height='65' alt='Immersion Blender KEB25 | KitchenAid' title='Immersion Blender KEB25 | KitchenAid' />" },
						   ...
						   thumb: "<img src='caracteristicas/thumb_page4.jpg' width='128' height='65' alt='5 velocidades' title='5 velocidades' />" } ];
