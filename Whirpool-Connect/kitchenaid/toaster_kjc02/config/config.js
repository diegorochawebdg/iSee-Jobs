...
/** Nome do produto **/
var $NOME_PRODUTO   = "Toaster  KJC02AFANA | KitchenAid";
var $NOME_FOLDER	= "toaster_kjc02/";
...
*/
var $CARACTERISTICAS = [ { nome: "Toaster  KJC02AFANA | KitchenAid" ,
						   src: "caracteristicas1.html" ,
						   thumb: "<img src='caracteristicas/thumb_page1.jpg' width='128' height='65' alt='Toaster  KJC02AFANA | KitchenAid' title='Toaster  KJC02AFANA | KitchenAid' />" },
						   ...
						   { nome: "Resultados diferenciados" ,
						   src: "caracteristicas3.html" ,
						   thumb: "<img src='caracteristicas/thumb_page3.jpg' width='128' height='65' alt='Resultados diferenciados' title='Resultados diferenciados' />" },
						   
						   { nome: "5 funções" ,
						   src: "caracteristicas4.html" ,
						   thumb: "<img src='caracteristicas/thumb_page4.jpg' width='128' height='65' alt='5 funções' title='5 funções' />" } ];

// Video IDs
var $VIDEOS	 = ["hAFbuBVtw04"];/** Tem vídeo? **/
var hasVideo = true;
