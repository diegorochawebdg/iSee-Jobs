...
/** Nome do produto **/
var $NOME_PRODUTO   = "Cooktop Facilite CDO60 | Consul";
var $NOME_FOLDER	= "cooktop_cdo60/";
...
var $CARACTERISTICAS = [ { nome: "Connect page1" ,
						   ...
						   thumb: "<img src='caracteristicas/thumb_page1.jpg' width='128' height='65' alt='Para um preparo ideal sem complicações' title='Para um preparo ideal sem complicações' />" },
...
// Video IDs
var $VIDEOS	 = ["eHxgOsf6VN8"];/** Tem vídeo? **/
var hasVideo = true;
