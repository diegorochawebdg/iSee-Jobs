package com.gugateider.framework.utils
{
	 ...
	 * Class responsible to manage arrays
	 */
	public class ArrayUtils 
	{
		
		/**
		 * 	Randomizes the array order using the Fisher-Yates method
		 * @param	array	-> Is the array you'd like to randomize
		 */
		public static function randomize(array:Array):Array 
		{
		  var aCopy:Array = array.concat();
		...
		/**
		 * Switch elements between the array
		 * @param	aArray
		 * @param	nIndexA
		 * @param	nIndexB
		 */
		...
		/**
		 * Get the equal values of the array
		 * @param	aArrayA
		 * @param	aArrayB
		 * @param	bNotOrdered
		 * @param	bRecursive
