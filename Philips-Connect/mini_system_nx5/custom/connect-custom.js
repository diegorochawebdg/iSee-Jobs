	...
	this.init = function(){
		...
		**/
		this.AnimationItens = [ 
                                    ...
                                    { object: $Connect( "#Connect-Section6 .Connect-Content .caixa-som" ) , startingClass: "bounceInDown s09 t10" , endClass: "bounceOut" },
                                    { object: $Connect( "#Connect-Section6 .Connect-Content .medidas" ) , startingClass: "fadeInRightBig s11 t10" , endClass: "fadeOutRightBig" },
							 ];
