...
/** Nome do produto **/
var $NOME_PRODUTO   = "Panela de Pressão Elétrica Chef PCC10 | Electrolux";
var $NOME_FOLDER	= "panela_pressao_eletrica_pcc10_novo/";
...
*/
var $CARACTERISTICAS = [ { nome: "Panela de Pressão Elétrica Chef PCC10 | Electrolux" ,
						   src: "caracteristicas1.html" ,
						   thumb: "<img src='caracteristicas/thumb_page1.jpg' width='128' height='65' alt='Panela de Pressão Elétrica Chef PCC10 | Electrolux' title='Panela de Pressão Elétrica Chef PCC10 | Electrolux' />" },
						 ...
						 { nome: "6 funções de cozimento" ,
						   src: "caracteristicas3.html" ,
						   thumb: "<img src='caracteristicas/thumb_page3.jpg' width='128' height='65' alt='6 funções de cozimento' title='6 funções de cozimento' />" },
...
// Video IDs
var $VIDEOS	 = ["pJA9pcF0rpY"];/** Tem vídeo? **/
var hasVideo = true;
